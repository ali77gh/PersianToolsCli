...
Interfaz de línea de comandos para la biblioteca [rust-persian-tools](https://github.com/persian-tools/rust-persian-tools).

## Ejemplo

### Con parámetro

Puede pasar la entrada mediante la opción `-i`:

<img src="./example-with-param.png" width=600></img>

### Con entrada estándar (std-in)
...
Existen tres formas de instalar persian tools cli

### 1. Descargar binario

Descargue el binario desde [aquí](https://github.com/ali77gh/PersianToolsCli/releases).
Agregue el binario a su PATH

### 2. Instalar desde crates.io

Si tiene cargo instalado, puede instalar esta herramienta simplemente ejecutando:
